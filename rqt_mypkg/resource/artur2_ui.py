...
################################################################################
## Form generated from reading UI file 'artur2.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget_6.setGeometry(QRect(0, 0, 491, 458))
        ...
        self.comboBox_parent = QComboBox(self.verticalLayoutWidget_6)
        ...
        self.comboBox_child = QComboBox(self.verticalLayoutWidget_6)
        ...
        self.steps_slider = QSlider(self.verticalLayoutWidget_6)
        ...
        self.steps_field = QLineEdit(self.verticalLayoutWidget_6)
        ...
        self.zero_button = QPushButton(self.verticalLayoutWidget_6)
        self.zero_button.setObjectName(u"zero_button")

        self.verticalLayout_7.addWidget(self.zero_button)

        self.load_default_button = QPushButton(self.verticalLayoutWidget_6)
